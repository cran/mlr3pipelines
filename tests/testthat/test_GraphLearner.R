...
test_that("GraphLearner hashes", {
  ...
  lr2 <- if (is.function(lrn("classif.rpart")$encapsulate)) {
    lrn("classif.rpart")$encapsulate("try", fallback = lrn("classif.rpart"))
  } else {
    lrn("classif.rpart", fallback = lrn("classif.rpart"))
  }
